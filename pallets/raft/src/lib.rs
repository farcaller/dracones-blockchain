...
use sp_consensus_raft::{AuthorityIndex, ConsensusLog, Slot, RAFT_ENGINE_ID};
use sp_runtime::{
	generic::DigestItem,
...
const LOG_TARGET: &str = "runtime::raft";
...
pub type RaftAuthorId<T> = FindAccountFromAuthorIndex<T, Pallet<T>>;
